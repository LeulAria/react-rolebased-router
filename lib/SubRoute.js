...
var SubRoute = function (_a) {
    var userAuthRoles = _a.userAuthRoles, loginRedirectPath = _a.loginRedirectPath, isUserAuthenticated = _a.isUserAuthenticated, blocked = _a.blocked, routeProps = _a.routeProps, routeParam = _a.routeParam, route = __rest(_a, ["userAuthRoles", "loginRedirectPath", "isUserAuthenticated", "blocked", "routeProps", "routeParam"]);
    ...
    return (react_1.default.createElement(react_1.Suspense, { fallback: route.fallback },
        react_1.default.createElement(react_router_dom_1.Route, __assign({}, routeProps, { path: route.path, render: function (props) {
                ...
                //check if role redirect
                    ...
                    return react_1.default.createElement(react_router_dom_1.Redirect, { to: route.redirectFallback || loginRedirectPath });
                }
                else if (route.protected) {
                    if (isUserAuthenticated) {
                        if (route.component) {
                            return (react_1.default.createElement(route.component, __assign({}, props, { routeParam: routeParam, routes: route.routes })));
                        }
                    }
