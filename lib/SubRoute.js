...
var SubRoute = function (_a) {
    var userAuthRoles = _a.userAuthRoles, loginRedirectPath = _a.loginRedirectPath, isUserAuthenticated = _a.isUserAuthenticated, blocked = _a.blocked, blockedComponent = _a.blockedComponent, route = __rest(_a, ["userAuthRoles", "loginRedirectPath", "isUserAuthenticated", "blocked", "blockedComponent"]);
    ...
    return (react_1.default.createElement(react_1.Suspense, { fallback: route.fallback },
        react_1.default.createElement(react_router_dom_1.Route, { path: route.path, render: function (props) {
                // block routing to specific route path and show a component
                if (blockedComponent) {
                    if (blockedComponent.isBlocked) {
                        if (blockedComponent.component) {
                            return react_1.default.createElement(blockedComponent.component, __assign({}, props, { routes: route.routes }));
                        }
                    }
                }
                ...
                if (blocked) {
                    if (blocked.isBlocked) {
                        if (blocked.path) {
                            return react_1.default.createElement(react_router_dom_1.Redirect, { to: blocked.path });
                        }
                    }
                }
